...
function traceMethod(targetClassMethod) {
    ...
    if (targetMethod.includes("getChildByName")) return;
    if (targetMethod.includes("callAppenders")) return;
    if (targetMethod.includes("buildLoggingEventAndAppend")) return;
    if (targetMethod.includes("appendLoopOnAppenders")) return;
...
traceClass('ch.qos.logback.classic.Logger')

//const logger = Java.use("ch.qos.logback.classic.Logger");
//
